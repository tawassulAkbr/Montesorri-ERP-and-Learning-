    ...
    <div className="min-h-screen flex flex-col bg-surface-50 text-surface-800">
      <header className="px-8 py-6 flex justify-between items-center border-b border-surface-100 bg-white shadow-sm">
        ...
        <nav className="space-x-6">
          ...
          <Link to="/login" className="text-brand-600 font-medium hover:text-brand-700 transition-colors">Login</Link>
          <Link to="/register" className="bg-brand-500 hover:bg-brand-600 text-white px-5 py-2 rounded-full font-medium transition-colors shadow-md hover:shadow-lg">Start Free Trial</Link>
        </nav>
      </header>
      ...
      <main className="flex-grow">
        <section className="px-8 py-24 text-center max-w-4xl mx-auto">
          ...
          <div className="flex justify-center gap-4">
            <Link to="/register" className="bg-brand-500 hover:bg-brand-600 text-white px-8 py-4 rounded-full text-lg font-semibold transition-all shadow-lg hover:shadow-xl hover:-translate-y-1">
              Start Your Free Trial
            </Link>
            <Link to="/login" className="bg-white hover:bg-surface-100 text-surface-800 border border-surface-200 px-8 py-4 rounded-full text-lg font-semibold transition-all shadow-sm hover:shadow-md">
              View Portals
            </Link>
          </div>
        </section>
