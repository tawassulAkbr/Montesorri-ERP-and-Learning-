  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Montessori Daily Work & Activity Logs</h1>
          <p className="text-sm text-slate-500">Post everyday sensorial milestones, circle summaries, and home guidance for parents</p>
        </div>
            ...
            <CardHeader className="p-4 bg-slate-50/70 border-b border-slate-100 flex flex-row items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-400">Posted by {work.teacherName}</p>
                </div>
              </div>
        ...
        <DialogContent className="max-w-xl">
          ...
          <form onSubmit={handlePostWork} className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                <Label className="text-xs font-medium text-slate-600">Class Cohort</Label>
                <select
                  value={targetClass}
            ...
            <div>
              <Label className="text-xs font-medium text-slate-600">Attachment File Name (Mock)</Label>
              <Input
                value={attachment}
